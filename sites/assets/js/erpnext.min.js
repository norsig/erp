...
$.extend(erpnext.utils, {
	...
	get_party_name: function get_party_name(party_type) {
...
erpnext.TransactionController = erpnext.taxes_and_totals.extend({
	...
	set_dynamic_labels: function set_dynamic_labels() {
		...
		if (this.frm.doc_currency !== this.frm.doc.currency || this.frm.doc_currency !== this.frm.doc.price_list_currency) {
	...
	apply_price_list: function apply_price_list(item, reset_plc_conversion) {
